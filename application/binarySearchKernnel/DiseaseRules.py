DiseaseRules =  {
    'Urethal Obstruction': {
               ...
               'Kitten': [1, 0, 0, 0, 0],
               'Young adult': [0, 0, 1, 0, 0],
               'Adult': [0, 0, 1, 0, 0],
               'Mature Adult': [0, 0, 1, 0, 0],
               'Old': [0, 0, 1, 0, 0],
               ...
               'Neutered': [0, 0, 1, 0, 0],
               'Symptoms started Less than a day': [0, 0, 0, 0, 1],
               'Symptoms started in one day to a week': [0, 0, 0, 0, 1],
               'Symptoms started in a week to a month': [1, 0, 0, 0, 0],
               'Symptoms started more than a month': [1, 0, 0, 0, 0],
               'Processed Diet': [0, 0, 1, 0, 0],
               'Natural Diet': [0, 0, 1, 0, 0],
    },
    'Feline Lower Urinary Tract Disease': {
               ...
               'Contact with other pets': [0, 0, 1, 0, 0],
               'Neutered': [0, 0, 1, 0, 0],
               'Symptoms started Less than a day': [0, 0, 1, 0, 0],
               'Symptoms started in one day to a week': [0, 0, 1, 0, 0],
               'Symptoms started in a week to a month': [0, 0, 1, 0, 0],
               'Symptoms started more than a month': [0, 0, 0, 1, 0],
               'Processed Diet': [0, 0, 1, 0, 0],
               'Natural Diet': [0, 0, 1, 0, 0],
    },
    'Renal Disease': {
               ...
               'Overweight': [0, 0, 1, 0, 0],
               'Kitten': [1, 0, 0, 0, 0],
               'Young adult': [1, 0, 0, 0, 0],
               'Adult': [1, 0, 0, 0, 0],
               'Mature Adult': [0, 0, 0, 0, 1],
               'Old': [0, 0, 0, 0, 1],
               'Vaccination updated': [0, 0, 1, 0, 0],
               'Male': [0, 0, 1, 0, 0],
               'Female': [0, 0, 1, 0, 0],
               ...
               'Contact with other pets': [0, 0, 1, 0, 0],
               'Neutered': [0, 0, 1, 0, 0],
               'Symptoms started Less than a day': [1, 0, 0, 0, 0],
               'Symptoms started in one day to a week': [1, 0, 0, 0, 0],
               'Symptoms started in a week to a month': [0, 0, 0, 0, 1],
               'Symptoms started more than a month': [0, 0, 0, 0, 1],
               'Processed Diet': [0, 0, 1, 0, 0],
               'Natural Diet': [0, 0, 1, 0, 0],
    },
    'Luxation': {
               ...
               'Symptoms started in one day to a week': [0, 0, 0, 0, 1],
               'Symptoms started in a week to a month': [0, 0, 0, 0, 1],
               'Symptoms started more than a month': [0, 0, 1, 0, 0],
               'Processed Diet': [0, 0, 1, 0, 0],
               'Natural Diet': [0, 0, 1, 0, 0],
    },
    'Panleukopenia': {
    ...
    #            'Kitten': [0, 0, 0, 0, 0],
    #            'Young adult': [0, 0, 0, 0, 0],
    #            'Adult': [0, 0, 0, 0, 0],
    #            'Mature Adult': [0, 0, 0, 0, 0],
    #            'Old': [0, 0, 0, 0, 0],
    #            'Vaccination updated': [0, 0, 0, 0, 0],
    #            'Male': [0, 0, 0, 0, 0],
    #            'Female': [0, 0, 0, 0, 0],
    #            'Indoor': [0, 0, 0, 0, 0],
    #            'Outdoor': [0, 0, 0, 0, 0],
